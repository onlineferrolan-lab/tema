...
{else}
  ...
  {*<div class="form-group row {if !empty($field.errors)}has-error{/if}">*}
    ...
    <div class="col-md-6{if ($field.type === 'radio-buttons')} form-control-valign{/if} {if !empty($field.errors)}has-error{/if}">
        <label for="inp" class="form-control-label js-input-column{if $field.required} required{/if} inp" for="field-{$field.name}">
                ...
                {/if}
                  ...
                  {if isset($field.availableValues.comment)}
                      <div class="content-comment">
                        <i class="material-icons infohidden">info</i>
                        <span class="form-control-comment">
                          {$field.availableValues.comment}
                        </span>
                      </div>
