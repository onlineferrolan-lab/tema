...
{block name='product_miniature_item'}
    {*    {dump($product)}*}
    <div class="product{*if !empty($productClasses)} {$productClasses}{/if*} {if ($product.product_type === 'combinations')}combined-product{/if} {if $page.page_name == "index"}col-xs-6 col-sm-3 col-lg-20{else}col-xs-6 col-sm-3{/if}">
