...
{block name='content'}
    ...
    <section id="main">
        ...
        <div class="row product-top-container">
            ...
            <div class="rightcolumn_top {if $product.id_product_attribute == 0} simple_container {/if}">
                
                {if $product.id_product_attribute == 0}
                    <div class="box_simple_info">
                {/if}
                ...
                {/block}
                <div id="estimateddelivery_content"></div>
                        ...
                        <div class="product-actions js-product-actions">
                            ...
                            {else}
                                {block name='product_buy'}
                                    ...
                                    {*block name='product_add_to_cart'}
                                        {hook h='displayEcommAddToCart' id_product=$product.id}
                                    {/block*}
                                    {block name='product_add_to_cart'}
                                        {include file='catalog/_partials/product-add-to-cart.tpl'}
                                    {/block}
        ...
        <div class="row product-container js-product-container">
            <div class="{if $product.id_product_attribute == 0} col-md-12 leftcolumn {else} col-md-7 leftcolumn{/if} ">
