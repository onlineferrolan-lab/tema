<div id="left-column" class="col-xs-12 col-sm-12 col-md-12 col-lg-3 sidebarmyaccount">
...
{*            {$page.meta.title}*}
        ...
        <div id="collapseMenuAccount" class="collapse in" aria-labelledby="headingDelivery" data-parent="#accordion" aria-expanded="true">
            <div class="card-body">
