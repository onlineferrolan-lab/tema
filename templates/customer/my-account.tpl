...
{*      <h1>{l s='Your account' d='Shop.Theme.Customeraccount'}</h1>*}
  ...
  {*      <h1>{l s='Your account' d='Shop.Theme.Customeraccount'}</h1>*}
  <h1 class="my-account-title">{l s='Hola %customerName%' sprintf=['%customerName%' => {$customer.firstname}] d='Shop.Theme.Customeraccount'}:</h1>
  <div class="my-account-description row">
    <div class="col-xs-12 col-sm-9 desc">
      {l s='En este apartado puedes editar tus datos personales, direcciones, revisar tus últimos pedidos...' d='Shop.Theme.Customeraccount'}
    </div>
    <div class="col-xs-12 col-sm-3 text-end" href="{$logout_url}">
      <a class="close_session myaccount" href="{$logout_url}">
        {*<span class="material-icons">logout</span>*}
        {l s='Salir' d='Shop.Theme.Customeraccount'}
      </a>
    </div>
      ...
      <div class="row">
        ...
        {if !$configuration.is_catalog}
          <a class="col-lg-6 col-md-6 col-xs-12" id="history-link" href="{$urls.pages.history}">
        ...
        {if $configuration.voucher_enabled && !$configuration.is_catalog}
          <a class="col-lg-6 col-md-6 col-xs-12" id="discounts-link" href="{$urls.pages.discount}">
            <span class="link-item">
        ...
        {if !$configuration.is_catalog}
          <a class="col-lg-6 col-md-6 col-xs-12" id="order-slips-link" href="{$urls.pages.order_slip}">
            <span class="link-item">
               <i class="icon-slip"></i>
              <div class="history-content">
        ...
        {if $configuration.return_enabled && !$configuration.is_catalog}
          <a class="col-lg-6 col-md-6 col-xs-12" id="returns-link" href="{$urls.pages.order_follow}">
            <span class="link-item">
               <i class="icon-order"></i>
              <div class="history-content">
        ...
        <a class="col-lg-6 col-md-6 col-xs-12" id="identity-link" href="{$urls.pages.identity}">
          <span class="link-item">
            <i class="icon-user"></i>
            <div class="history-content">
        ...
        {if $customer.addresses|count}
          <a class="col-lg-6 col-md-6 col-xs-12" id="addresses-link" href="{$urls.pages.addresses}">
            <span class="link-item">
        ...
        {else}
          <a class="col-lg-6 col-md-6 col-xs-12" id="address-link" href="{$urls.pages.address}">
            <span class="link-item">
               <i class="icon-address"></i>
              <div class="history-content">
        ...
        <div class="displayCustomerAccountContent">
