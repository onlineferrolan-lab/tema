        ...
        {foreach from=$subcategories item=subcategory}
          <li>
              <div class="contentsubcategory">
                ...
                <a class="subcategory-name text-center displayBlock" href="{$link->getCategoryLink($subcategory.id_category, $subcategory.link_rewrite)|escape:'html':'UTF-8'}">{$subcategory.name|truncate:25:'...'|escape:'html':'UTF-8'}</a>
              </div>
          </li>
        {/foreach}
      </ul>
