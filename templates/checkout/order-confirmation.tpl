...
{block name='page_content_container' prepend}
    <section id="content-hook_order_confirmation" class="card">
      <div class="card-block">
          ...
          <div class="col-md-12 alert alert-success container-header-order-confirmation">

            {block name='order_confirmation_header'}
              <h3 class="h1 card-title fs-3">
...
{block name='page_content_container'}
  <div class="container_order-confirmation-details">
      ...
      <section id="content_details" class="page-content page-order-confirmation-details card">
    ...
    <div class="extra-order-confirmation">
