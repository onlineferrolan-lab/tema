...
{block name='page_content_container'}
  <section id="content" class="page-content page-stores">
    <div class="header_stores">
        <h1>{l s='Our stores' d='Shop.Theme.Global'}</h1>
        <span>{l s='Lorem ipsum dolor sit amet, consectetur adipiscing elit. Vivamus pretium vel ante id porta. Vivamus accumsan erat et quam consequat, at venenatis neque rutrum. Proin pharetra bibendum interdum. Etiam cursus pellentesque arcu, eu convallis est. Aenean a molestie nisl. Vestibulum ante ipsum primis in faucibus orci luctus et ultrices posuere' d='Shop.Theme.Global'}</span>
    </div>
    <div class="stores_block">    {foreach $stores as $store}
      <article id="store-{$store.id}" class="store-item card">
        <div class="store-item-container clearfix">
          <div class="col-md-4 col-xs-12 store-picture">
            <img
          ...
          <div class="col-md-4 col-xs-12 divide-left schedule_container">
            <table>
