    ...
    <div class="modal-content">
      ...
      <div class="modal-body">
        <form id="post-product-comment-form" action="{$post_comment_url nofilter}" method="POST">
          <div class="row">
            <div class="col-sm-2">
              {if isset($productProductComment) && $productProductComment}
...
{*                {/block}*}
                ...
                {block name='product_cover'}
                  <div class="product-cover">
                    {if $productProductComment->image}
                      <img class="js-qv-product-cover" src="{$productProductComment->image}" alt="{$productProductComment->name}" title="{$productProductComment->name}" style="width:100%;" itemprop="image">
                    {else}
            ...
            <div class="col-sm-4">
              <p class="h3">{$productProductComment->name}</p>
              {block name='product_description_short'}
                <div itemprop="description">{$productProductComment->description_short nofilter}</div>
              {/block}
            </div>
            <div class="col-sm-6">
