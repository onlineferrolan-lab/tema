		...
		{if isset($as_location_name) && $as_location_name}
			...
			if(typeof(as4Plugin.locationName) != 'undefined' && as4Plugin.locationName) {ldelim}
				$(document).ready(function() {ldelim}
					$('#PM_ASBlock_{$as_search.id_search|intval} .PM_ASResetSearch').html("<span class='material-icons'>skip_previous</span>{l s='Back to' mod='pm_advancedsearch4' js=1} " + as4Plugin.locationName);
				{rdelim});
			{rdelim}
		{/if}
