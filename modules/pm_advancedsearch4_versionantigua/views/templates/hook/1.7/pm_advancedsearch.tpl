{if isset($as_searchs)}
	...
	{foreach from=$as_searchs item=as_search name=as_searchs}
		...
		<a {if !isset($smarty.get.id_seo) && isset($as_selected_criterion) && is_array($as_selected_criterion) && !sizeof($as_selected_criterion)}style="display: none" {/if}href="#" class="PM_ASResetSearch">
			<span class="material-icons-outlined">loop</span>
			<span>{l s='Clear filters' mod='pm_advancedsearch4'}</span></a>


			<div class="order_content_AS4">
				<span class="material-icons">filter_list</span>
				<div class="container_options"></div>
			</div>
