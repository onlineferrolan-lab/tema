...
{*    <span id="language-selector-label" class="hidden-md-up">{l s='Language:' d='Shop.Theme.Global'}</span>*}
    <div class="language-selector dropdown js-dropdown">
      <button id="language-selector-label" data-toggle="dropdown" class="hidden-sm-down btn-unstyle" aria-haspopup="true" aria-expanded="false" aria-label="{l s='Language dropdown' d='Shop.Theme.Global'}">
      ...
      <div class="mobilelangauge link hidden-md-up" aria-labelledby="language-selector-label">
        {foreach from=$languages item=language}
          <div class="item {if $language.id_lang == $current_language.id_lang}selected{/if}">
