    ...
    $.extend($.fn.jGrowl.prototype, {
        ...
        render: function (notification) {
            ...
            $(notification).bind("mouseover.jGrowl", function () {
                ...
                if (o.open.apply(notification, [notification,
                    message, o,
                    self.element
                ]) != false) {
                    if (o.glue == 'after') {
                    ...
                    $(this).animate(o.animateOpen, o.openDuration, o.easing, function () {
                        ...
                        if ($(this).data("jGrowl") != null) $(this).data("jGrowl").created = new Date();
                        $(this).trigger('jGrowl.afterOpen');
                    });
                }
            }).bind('jGrowl.afterOpen', function () {
                o.afterOpen.apply(notification, [notification,
                    message, o,
                    self.element
                ]);
                ...
                if (o.beforeClose.apply(notification, [
                    ...
                    message, o,
                    self.element
                ]) != false) $(this).trigger('jGrowl.close');
            ...
            if ($('div.jGrowl-notification:parent', self.element).size() > 1 && $('div.jGrowl-closer', self.element).size() == 0 && this.defaults.closer != false) {
                $(this.defaults.closerTemplate).addClass('jGrowl-closer custom-alert alert-success ui-corner-all').addClass(this.defaults.theme).appendTo(self.element).animate(this.defaults.animateOpen, this.defaults.speed, this.defaults.easing).bind("click.jGrowl", function () {
