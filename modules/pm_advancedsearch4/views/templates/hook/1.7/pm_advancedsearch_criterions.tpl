{if $criterions_group.max_display == 99 || ($as_search.reset_group|intval && isset($as_search.selected_criterion[$criterions_group.id_criterion_group]) && sizeof($as_search.selected_criterion[$criterions_group.id_criterion_group]))}
	{assign var="filteractive" value=1}
{else}

	{assign var="filteractive" value=0}
{/if}
...
{else}
<p class="PM_ASCriterionsGroupTitle h4 {if $filteractive == 1}active{/if}" id="PM_ASCriterionsGroupTitle_{$as_search.id_search|intval}_{$criterions_group.id_criterion_group|intval}" rel="{$criterions_group.id_criterion_group|intval}">
...
<div class="PM_ASCriterionsGroupOuter" {if $filteractive == 1}style="display: block"{/if}>
