            ...
            {if $node.type==2}
                ...
                {if isset($node.content_s.title)}
                    {if isset($node.content_s.href)}
                        <a href="{$node.content_s.href}"
                           class="cbp-column-title{if  isset($node.content.view) && $node.content.view==2 && $node.contentType==3} cbp-column-title-inline{/if}" title="{$node.content_s.title}">{$node.content_s.title} {if isset($node.content_s.legend)}
                                    ...
                                    {if isset($category.title)}
                                        <div class="col-xs-{$node.content.line}">
                                            <div class="cbp-category-link-w"><a href="{$category.href}"
                                                                                class="cbp-column-title cbp-category-title" title="{$category.title}">{$category.title}</a>
                            ...
                            {foreach from=$node.content.ids item=va_link}
                                {if isset($va_link.href) && isset($va_link.title) && $va_link.href != '' && $va_link.title != ''}
                                    <li><a href="{$va_link.href}"
                                           {if isset($va_link.new_window) && $va_link.new_window}target="_blank"{/if} title="{$va_link.title}">{$va_link.title}</a>
                                    </li>
                                {/if}
                            {/foreach}
                        </ul>
                ...
                {elseif $node.contentType==6}
                    ...
                    {if isset($node.content.source)}
                        ...
                        <img src="{$node.content.source}" class="img-fluid cbp-banner-image" alt="{$node.content_s.legend}" title="{$node.content_s.legend}"
